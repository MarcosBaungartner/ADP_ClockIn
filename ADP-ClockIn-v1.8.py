...
if not os.path.isfile(f'{os.path.dirname(os.path.abspath(__file__))}\\path.txt'):
...
arq=open(f'{os.path.dirname(os.path.abspath(__file__))}\\path.txt', encoding='utf_8') # Abre arquivo em modo somente leitura
...
def login():
    ...
    entry_user.insert(0, '') # Username here
    ...
    entry_password.insert(0, '') # Password here
